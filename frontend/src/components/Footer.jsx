      ...
      <footer className="row row-footer m-0 p-0">
        <div className="col-md-4 col-sm-12 area-footer d-flex  align-items-center justify-content-center ">
          <div className="area-col-footer">
            ...
            <p>
              Somos a maior e melhor loja de vendas de jogos em mídia digital.
              Comércio e venda de games para Playstation 4, Mídia digital e
              jogos em geral e produtos originais sony.
            </p>
          </div>
        </div>
        ...
        <div className="col-md-4 col-sm-12 area-footer d-flex  align-items-center justify-content-center">
          <div className="area-col-footer">
            ...
            <p>
              <i class="fab fa-whatsapp mr-2"></i> 551190000-0000
            </p>
            <p>
              <i class="fas fa-phone mr-2"></i>0000-0000
            </p>
            <p>
              <i class="fas fa-envelope mr-2"></i>FSG@gmail.com.br
            </p>
          </div>
        </div>
        ...
        <div className="col-md-4 col-sm-12 area-footer2 d-flex  align-items-center justify-content-center ">
          <div className="area-col-footer2 "></div>
        </div>
        ...
        <div className="col-12 area-footer3 d-flex  align-items-center justify-content-center">
          <p className="mt-3">
            &copy; PaperThing - Todos os direitos Reservados -
            <a
              className="nome-footer"
              href="https://www.linkedin.com/in/assuncaoariani/"
              target="_blank"
            >
              {" "}
              Ariani Balbino
